...
<title>DaC.test_DaC_N1 API documentation</title>
<meta name="description" content="File with the tests, both for eigenstates and dynamics of the Anderson model." />
...
def test_dyn_N1():
    ...
    for L in L_array:
        for W in W_array:
            ...
            check_PR_dyn_N1(L, M, W)</code></pre>
</details>
</section>
<section>
</section>
...
<pre><code class="python">def check_PR_dyn_N1( L, M, W ):
    &#39;&#39;&#39;
    Check that we obtain the dynamics using DaC and ED
    (system should be small enough to do ED).
    &#39;&#39;&#39;
    ...
    if( len(sites) == L and L &lt; 6000):
        ...
        assert (max_error &lt; precision) == True</code></pre>
</details>
</dd>
...
<pre><code class="python">def check_eigenvalues_DaC_N1( L, M, W):
    &#39;&#39;&#39;
    Check that we obtain the same eigenstates using DaC and ED
    (system should be small enough to do ED).
    &#39;&#39;&#39;
    ...
    if( len(E) == L ):
        assert np.allclose( population, np.ones(L) ) == True</code></pre>
</details>
</dd>
...
<pre><code class="python">def test_dyn_N1():
    &#39;&#39;&#39;
    Provide input for some test (dynamics).
    &#39;&#39;&#39;
    M = 200
...
<pre><code class="python">def test_eigen_N1():
    &#39;&#39;&#39;
    Provide input for some test (eigenstates).
    &#39;&#39;&#39;
    M = 200
    ...
    for L in L_array:
        for W in W_array:
            ...
            check_eigenvalues_DaC_N1(L, M, W)</code></pre>
</details>
</dd>
</dl>
</section>
