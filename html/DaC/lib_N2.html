...
<meta name="description" content="Module with the functions to implement the DaC for
...
<p>Module with the functions to implement the DaC for
the Two Interacting Particles (TIP) problem.</p>
...
<span>def <span class="ident">DaC_N2_dyn</span></span>(<span>parameters_system, time, parameters_technical)</span>
</code></dt>
<dd>
<div class="desc"><p>Main function to calculate the dynamics in the TIP problem.</p>
<ul>
<li>
<p><strong>parameters_system</strong>: Object of the class <strong>System_Parameters_TIP</strong>,
...
<pre><code class="python">def DaC_N2_dyn( parameters_system, time, parameters_technical):
    &#39;&#39;&#39;
    Main function to calculate the dynamics in the TIP problem.\n
...
<span>def <span class="ident">DaC_eigen_N2</span></span>(<span>parameters_system, parameters_technical)</span>
</code></dt>
<dd>
<div class="desc"><p>Main function to obtain localized eigenstates of the TIP problem.</p>
<ul>
<li>
<p><strong>parameters_system</strong>: Object of the class <strong>System_Parameters_TIP</strong>,
containing physical parameters to describe the system.</p>
...
<pre><code class="python">def DaC_eigen_N2( parameters_system, parameters_technical):
...
<dd>
<div class="desc"><p>Give back the eigenvalues (E) and eigenfunction itself (v).</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the PR using ED, only for small systems.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Create banded matrix.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the PR in real space.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Check variance of a possible eigen.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Compare if eigenfunctions equal or not</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Determine which nodes are connected by the hopping, connects site (i,j)
to sites (i+-1, j) and (i, j+-1)</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the dynamics of the states in a given subsystem (interval).</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate which entries represent 1 particle in the left edge of the
subsystem (auxi_left), the right end (auxi_right),
and where the 2 particles are next to each other (where_together)</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the PR in Fock space, vectors stored as rows of matrix psi</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the PR from normalized density, vectors stored as rows of matrix psi.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the fluctuation of the CoM</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the observables of interest and store them in object of class
<strong>Observables_TIP_class</strong>.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Calculate the mean distance of state, stored as rows of matrix psi.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>All the parameters needed to calculate the observables.</p>
<p>First is for the mean distance, second for CoM,
third and forth for PR density, fifth for probability together</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Population on consecutive sites (i,i+1).</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Used when comparing eigenfunctions from different subset,
give us the common entries. Assume that the subsystem have different sizes.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
...
<dd>
<div class="desc"><p>Implement the Reverse Cuthill-McHill (RCM) algorithm, to reduce the bandwidth
of the matrix.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
...
<dd>
<div class="desc"><p>Calculates the PR of the initial states (rows of A)
as a function of time (T).</p>
<p>It uses numba, to speed up the for loop.</p>
<p>We do not do a matrix multiplication to save memory.</p></div>
<details class="source">
<summary>
<span>Expand source code</span>
</summary>
