...
<title>DaC.test_DaC_N2 API documentation</title>
<meta name="description" content="File with the tests, for the dynamics of the TIP problem." />
...
def test_dyn_N2():
    ...
    for L in L_array:
        for W in W_array:
            ...
            check_PR_dyn_N2(L, M, W)</code></pre>
</details>
</section>
<section>
</section>
...
<pre><code class="python">def check_PR_dyn_N2( L, M, W ):
    &#39;&#39;&#39;
    Check that we obtain the dynamics using DaC and ED
    (system should be small enough to do ED).
    &#39;&#39;&#39;
...
<pre><code class="python">def test_dyn_N2():
    &#39;&#39;&#39;
    Provide input for some test (dynamics).
    &#39;&#39;&#39;
    M = 50
